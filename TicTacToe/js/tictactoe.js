...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O' so, if not 'X' it must b 'O'
        } else {
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This function waits 1 second bfore computer places image and enables click.
...
function checkWinConditions() {
    ...
    // O 6, 7, 8 condition.
    else if (arrayIncludes('6O', '7O', '3O')) { drawWinLine(50, 508, 558, 508) }
    //O 0, 3, 6 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    animateLineDrawing();
    // This line waits 1 second. Then, clars canvas, resets game, and allows clicking again.
...
function resetGame() {
    ...
    for (let i=0; i < 9; i++) {
        // This variable gets the html elment of i.
